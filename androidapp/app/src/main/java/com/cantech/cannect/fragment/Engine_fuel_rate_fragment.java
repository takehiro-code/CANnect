 ...
 * Use the {@link Engine_fuel_rate_fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Engine_fuel_rate_fragment extends Fragment {
    ...
    public Engine_fuel_rate_fragment() {
     ...
     * @return A new instance of fragment Engine_fuel_rate_fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Engine_fuel_rate_fragment newInstance(String param1, String param2) {
        Engine_fuel_rate_fragment fragment = new Engine_fuel_rate_fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_engine_fuel_rate, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        fuelRate = view.findViewById(R.id.fuelRate_TextView);
    }
