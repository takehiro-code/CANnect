 ...
 * Use the {@link Demand_Engine_Torque_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Demand_Engine_Torque_Fragment extends Fragment {

    private static final String TAG = "Demand Torque Fragment";
    TextView demandETorque;
     ...
     * @return A new instance of fragment Demand_Engine_Torque_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Demand_Engine_Torque_Fragment newInstance(String param1, String param2) {
        Demand_Engine_Torque_Fragment fragment = new Demand_Engine_Torque_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_demand_engine_torque, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        demandETorque = view.findViewById(R.id.demanETorque_TextView);
