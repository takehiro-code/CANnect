        ...
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            new Thread()
            {
                public void run() {
                    ...
                    try {
                        BTCommunication BT = new BTCommunication();
                        mBTSocket = BT.createBluetoothSocket(device);
                    } catch (IOException e) {
                        fail = true;
                    ...
                    if(fail == false) {
                        SocketHandler.setSocket(mBTSocket);
                        mConnectedThread = new BTCommunication.ConnectedThread(mBTSocket, Connect.this);
