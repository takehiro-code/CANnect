 ...
 * Use the {@link Throttle_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Throttle_Fragment extends Fragment {
    private static final String TAG = "Throttle Fragment";
    TextView throttle;
     ...
     * @return A new instance of fragment Throttle_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Throttle_Fragment newInstance(String param1, String param2) {
        Throttle_Fragment fragment = new Throttle_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_throttle, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        throttle = view.findViewById(R.id.throttle_TextView);
    }
