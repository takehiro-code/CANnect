 ...
 * Use the {@link Intake_air_temp_fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Intake_air_temp_fragment extends Fragment {
    ...
    public Intake_air_temp_fragment() {
     ...
     * @return A new instance of fragment Intake_air_temp_fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Intake_air_temp_fragment newInstance(String param1, String param2) {
        Intake_air_temp_fragment fragment = new Intake_air_temp_fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_intake_air_temp, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        intake = view.findViewById(R.id.intake_TextView);
    }
