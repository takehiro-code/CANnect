 ...
 * Use the {@link Time_run_with_mil_on_fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Time_run_with_mil_on_fragment extends Fragment {
    ...
    public Time_run_with_mil_on_fragment() {
     ...
     * @return A new instance of fragment Time_run_with_mil_on_fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Time_run_with_mil_on_fragment newInstance(String param1, String param2) {
        Time_run_with_mil_on_fragment fragment = new Time_run_with_mil_on_fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_time_run_with_mil_on, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        milon = view.findViewById(R.id.milon_TextView);
    }
    ...
    BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                switch (parsed[0]) {
                    case "TIME RUN WITH MIL ON":
                        //changing string to float.
                        milon.setText(parsed[1]);
                        break;
